...
int main()
{
	...
	Model linterna("resources/objects/Linterna/linterna.obj");
	Model cofre("resources/objects/Cofre/cofre.obj");
	Model filtro("resources/objects/Filtro/filtro.obj");
	Model medusa("resources/objects/Medusa/medusa.obj");
	Model cristal("resources/objects/Cristal/cristal.obj");
	Model puff("resources/objects/Puff/puff.obj");
	Model mesa("resources/objects/Mesa/mesa.obj");
	Model mueble("resources/objects/Mueble/mueble.obj");
	...
	Model casaDoll("resources/objects/Cuarto/cuarto.obj");

	ModelAnim animacionPersonaje("resources/objects/Personaje1/PersonajeBrazo.dae");
	animacionPersonaje.initShaders(animShader.ID);

	ModelAnim ninja("resources/objects/AlienAgua/alienagua.dae");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(300.3f, 100.75f, 0.3f)); // translate it down so it's at the center of the scene
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(170.0f, 75.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		staticShader.setMat4("model", model);
		cristal.Draw(staticShader);
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-250.0f, 25.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		staticShader.setMat4("model", model);
		linterna.Draw(staticShader);
